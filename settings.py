...
deliverymen = {"Антон_Жижа_Центр": 640287782, 'Склад': 1}
admin = 1904018585
admin_2 = 754288169
admin_3 = 5929705793
delyverymen_id = {"Антон_Жижа_Центр": '@slutmee', 'Склад': '@sklad'}
...
Тех. поддержка @servernayaKurgan'''
text_start = 'Привет! Этот бот предназначен для того, чтобы вы всегда могли узнать наличие товара у доставщика.' \
             ...
             'Купить жидкость t.me/MoonVapeKgn/393\n' \
